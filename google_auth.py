...
LOGINAUTH_REDIRECT_URI = f"https://{DOMAIN_NAME}/google/loginauth"
GA_CONNECTAUTH_REDIRECT_URI = f"https://{DOMAIN_NAME}/google/connectauth"
GSC_CONNECTAUTH_REDIRECT_URI = f"https://{DOMAIN_NAME}/google/gscconnectauth"
ADW_CONNECTAUTH_REDIRECT_URI = f"https://{DOMAIN_NAME}/google/adwconnectauth"
BASE_URI = f"https://{DOMAIN_NAME}/getstarted/connect-accounts"
